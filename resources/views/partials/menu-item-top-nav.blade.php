@if (is_array($item))
    <li class="{{ $item['top_nav_class'] }}">
        ...
        >
            ...
            @if (isset($item['label']))
                <span class="label label-{{ $item['label_color'] or 'primary' }}">{{ trans('adminlte::menu.'.$item['label']) }}</span>
                    ...
                    <li class="{{ $subitem['top_nav_class'] }}">
                        <a href="{{ $subitem['href'] }}">
                            ...
                            @if (isset($subitem['label']))
                                <span class="label label-{{ $subitem['label_color'] or 'primary' }}">{{ trans('adminlte::menu.'.$subitem['label']) }}</span>
                            @endif
                        </a>
                    </li>
                    @endif
