...
class PluginsCatalog
{
    ...
    protected $plugins = [
        ...
        'datatablesButtons' => [
            'name' => 'Datatables Buttons (requires jQuery and Datatables)',
            'package' => 'datatables.net-buttons',
            'version' => '^4.0',
            'resources' => [
                ['source' => 'datatables.net-buttons/js', 'target' => 'datatables/js'],
                ['source' => 'datatables.net-buttons-bs5/js', 'target' => 'datatables/js'],
                ['source' => 'datatables.net-buttons-bs5/css', 'target' => 'datatables/css'],
                ['source' => 'jszip/dist/jszip.min.js', 'target' => 'datatables/js/jszip.min.js'],
                ['source' => 'pdfmake/build', 'target' => 'datatables/js'],
            ],
            'recursive' => false,
            'ignore' => ['*.map', '*.d.ts', '*.mjs'],
        ],
    ...
    protected $legacyPlugins = [
        ...
        'datatablesPlugins' => 'datatablesButtons',
