...
4. From time to time, new configuration options are added or default values changes, so it is a recommendation to also update the `adminlte.php` config file.
